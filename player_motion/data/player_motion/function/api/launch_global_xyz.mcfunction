...
execute if predicate player_motion:internal/large_global as d4bd74a7-4e82-4a07-8850-dfc4d89f9e2f in minecraft:overworld positioned 0.0 0.0 0.0 store success score $temp player_motion.internal.dummy run function player_motion:internal/math/large_global_to_local
