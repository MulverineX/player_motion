...
execute \
    ...
    scoreboard players operation $motion_x player_motion.internal.old.math = @s player_motion.internal.motion.x
execute \
    ...
    scoreboard players operation $motion_y player_motion.internal.old.math = @s player_motion.internal.motion.y
execute \
