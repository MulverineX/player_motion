...
scoreboard players operation $x player_motion.internal.dummy *= $x player_motion.internal.dummy
scoreboard players operation $vec_i.z player_motion.internal.dummy *= $z player_motion.internal.dummy

scoreboard players operation $y player_motion.internal.dummy *= $x player_motion.internal.dummy
scoreboard players operation $vec_j.y player_motion.internal.dummy *= $y player_motion.internal.dummy
scoreboard players operation $vec_j.z player_motion.internal.dummy *= $z player_motion.internal.dummy

scoreboard players operation $z player_motion.internal.dummy *= $x player_motion.internal.dummy
scoreboard players operation $vec_k.y player_motion.internal.dummy *= $y player_motion.internal.dummy
scoreboard players operation $vec_k.z player_motion.internal.dummy *= $z player_motion.internal.dummy
