...
execute if score $y player_motion.internal.dummy matches ..-1 run scoreboard players set $sign player_motion.internal.dummy -1
...
execute store result score $y player_motion.internal.dummy run function player_motion:internal/convert_from_legacy/index with storage player_motion:internal/temp convert