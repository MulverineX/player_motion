...
execute store result score $x player_motion.api.launch run function player_motion:internal/convert_from_legacy/index with storage player_motion:internal/temp convert